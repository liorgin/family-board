...
import { GOOGLE_CLIENT_ID } from './GoogleLoginButton';
import JSONPretty from 'react-json-pretty';
import ApiCalendar, { ConfigApiCalendar } from '../common/google/ApiClanedar';


  const config :  ConfigApiCalendar = {
    clientId: GOOGLE_CLIENT_ID,
    apiKey: "AIzaSyC22BGfsjfJfOJ0Az8cQrSHPPI2B4avryk",
